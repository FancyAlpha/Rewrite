...
module.exports = function(gulp) {
  ...
  gulp.task('package uncompressed styles', function() {
  ...
  gulp.task('package compressed styles', function() {
    return gulp.src(output.uncompressed + '/**/' + globs.components + globs.ignored + '.css')
      .pipe(plumber())
      .pipe(dedupe())
      .pipe(replace(assets.uncompressed, assets.packaged))
  ...
  if(config.rtl) {
    ...
    gulp.task('package uncompressed rtl styles', function () {
    ...
    gulp.task('package compressed rtl styles', function () {
      return gulp.src(output.uncompressed + '/**/' + globs.components + globs.ignoredRTL + '.rtl.css')
        .pipe(dedupe())
        .pipe(replace(assets.uncompressed, assets.packaged))
    ...
    gulp.task('package uncompressed docs styles', function() {
      return gulp.src(output.uncompressed + '/**/' + globs.components + globs.ignored + '.css')
        .pipe(dedupe())
        .pipe(plumber())
        .pipe(replace(assets.uncompressed, assets.packaged))
    ...
    gulp.task('package compressed docs styles', function() {
      return gulp.src(output.uncompressed + '/**/' + globs.components + globs.ignored + '.css')
        .pipe(dedupe())
        .pipe(plumber())
        .pipe(replace(assets.uncompressed, assets.packaged))
